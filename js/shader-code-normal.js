...
layout(location=4) in vec3 vTang2;

uniform mat4 uModel;
uniform mat4 uView;
uniform mat4 uProjection;

// TODO: Part 3 - declare any output variables here.
...
void main() {
    // TODO: Part 3 - compute gl_Position as well as any output variables you
    ...
    fTang = normalize( mat3(mv) * (vTang) );
    fTang2 = normalize(mat3(mv) * (vTang2) );
...
// TODO: Part 3 - declare any input variables here
...
void main() {
    ...
    vec3 nMap = texture(normalMap, fUv).rgb;
    vec3 n   = normalize(fNormal*(nMap[2]-0.5)+(fTang*(nMap[0]-0.5)*bumpiness)+(fTang2*(nMap[1]-0.5)*bumpiness));
